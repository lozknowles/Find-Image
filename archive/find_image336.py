...
# - Improved error handling for images without GPS data
# - Fixed issue with formatting None values in confidence calculation
# - Enhanced debug output for better troubleshooting
# Changes in 3.0.35:
# - Fixed montage creation to ensure all images are displayed without cropping
# - Added buffer space to montage height calculation
# - Implemented dynamic cropping of unused space in montage
# Changes in 3.0.34:
...
def create_montage(similar_images, target_image_path, similarity_threshold, geo_threshold):
    ...
    # Add similar images
    for i, (img_path, _, confidence, similarity, object_similarity, _, geo_distance, _, _, _) in enumerate(similar_images):
